...
module Api
  module V1
    # Authenticated controller returning hardcoded Ethiopian license categories.
    # Requires a valid JWT. Each category (B, C, D, A) includes ETB pricing,
    # age requirements, and mandated training hours.
